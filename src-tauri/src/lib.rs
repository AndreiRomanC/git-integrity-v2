...
pub fn run() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            repository::branches::create_branch_at_commit,
            ...
            repository::preview_folder_restore,
            ...
            repository::branches::merge::merge_branch,
            repository::branches::merge::merge_in_progress,
            repository::branches::merge::list_conflicts,
            repository::branches::merge::conflict_sides,
            repository::branches::merge::open_merge_tool,
            repository::branches::merge::resolve_conflict,
            repository::branches::merge::complete_merge,
            repository::branches::merge::abort_merge,
